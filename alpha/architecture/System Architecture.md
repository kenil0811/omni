...
| Generated backend | Python 3.13 Entrypoint functions declared through the App SDK, 'uv', and 'uv.lock'; hosted by the platform App runtime (FastAPI, Pydantic 2, Uvicorn) | Separate supervised App process using only the versioned platform SDK and resolved execution closure |
